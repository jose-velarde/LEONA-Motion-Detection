...
def make_triggerframe_list():
    # rootdir = "C:/Users/Rede LEONA/Downloads/Jose Downloads/OpenCV"
    rootdir = "C:/Users/JoseVelarde/Downloads/Personal/LEONA/LEONA-Motion-Detection/Footage review/018-12-13_235655_533/"
    # Look for unedited video clips
    # regexframe = re.compile("(.*)(Positives|False positives)(.)(\d+)(\.png$)")
    regexframe = re.compile("(.*)(Positives|False positives)(.)(\d+)( - original)(\.png$)")
    triggerframe_list = []
    for root, dirs, files in os.walk(rootdir):
        for file in files:
            path = os.path.join(root,file)
